      ...
      * On appelle l'accesseur pour r‚cup‚rer une liste de personnes
      * dans TPERS
              CALL C-TPERSPGM USING ENTREE SORTIE
              END-CALL

              PERFORM VARYING I-I FROM 1 BY 1 UNTIL I-I > NB-POSTE-LISTE
      * On consolide les donn‚es des 2 tables dans le fichier de sortie
      * PERFORM … pr‚voir suivant le retour de l'accesseur.
