//CMPPGMDB  JOB MSGLEVEL=1,REGION=0M,NOTIFY=&SYSUID,CLASS=A,MSGCLASS=H
...
//   SET DSPREFIX='ENSISA.PROJETx'.           DATASETs PREFIX
...
//SYSLMOD  DD DISP=SHR,DSN=ENSISA.EXEC.LOAD(&MEM.)
